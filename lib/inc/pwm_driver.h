 ...
 * as selector.
 * @param duty_cycle New duty cycle in percentage. Possible values from 0% to
 * 101%
 * using the values 0 to 1010 for better resolution than just 1%
 */
 ...
 * selector.
 * @return Value of the pwm channels duty cycle
 */
